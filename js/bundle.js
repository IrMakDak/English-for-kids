...
/* harmony import */ var _statisticsPage_createLocalStorage__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../statisticsPage/createLocalStorage */ "./js/pages/statisticsPage/createLocalStorage.js");
/* harmony import */ var _showPage__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../showPage */ "./js/pages/showPage.js");
...
var CategoryCard = /*#__PURE__*/function () {
  function CategoryCard(src, title, translate, audio, key) {
    ...
    this.id = (0,_showPage__WEBPACK_IMPORTED_MODULE_18__.shortName)(title);
    this.key = key;
  }
  _createClass(CategoryCard, [{
    ...
    value: function render() {
      ...
      if (localStorage.getItem('theme') === 'train') {
        col.innerHTML = "\n                <div class=\"card card__front\">\n                    <img src=".concat(this.src, " alt=").concat(this.alt, " class=\"album-img\">\n                    <div class=\"cards-numbers\">\n                        <p class=\"card-text\">").concat(this.title, "</p>\n                        <img src=\"./assets/icons/turnOverCard.png\" alt=\"turn over\" class=\"translate-icon\">\n                    </div>\n                </div>\n                <div class=\"card-inverted card__back\">\n                    <div class=\"translate\">").concat(this.translate, "</div>\n                </div>\n            ");
        col.querySelector('.card').addEventListener('click', function (e) {
          console.log(_this.key);
          (0,_statisticsPage_createLocalStorage__WEBPACK_IMPORTED_MODULE_17__.editStatistics)(_this.key, _this.title, 'trainClick');
          if (e.target !== col.querySelector('.translate-icon')) {
            new Audio("".concat(_this.audio)).play();
          } else {
            turnOverCard(col);
          }
        });
      ...
      if (localStorage.getItem('theme') === 'play') {
        col.innerHTML = "\n                <div class=\"card\" id=".concat(this.id, ">\n                    <img src=").concat(this.src, " alt=").concat(this.alt, " class=\"album-img\">\n                </div>\n            ");
      }
...
function turnOverCard(parentOfCard) {
  var cleanCards = document.querySelectorAll('.rotate180');
  var cleanInv = document.querySelectorAll('.rotate360');
  if (cleanCards) {
    cleanCards.forEach(function (i) {
      i.classList.remove('rotate180');
    });
  }
  if (cleanInv) {
    cleanInv.forEach(function (i) {
      i.classList.remove('rotate360');
    });
  }
  var card = parentOfCard.querySelector('.card');
  var cardInverted = parentOfCard.querySelector('.card-inverted');
  card.classList.add('rotate180');
  cardInverted.classList.add('rotate360');
  cardInverted.addEventListener("mouseout", function () {
...
function flipCardByClick() {
  document.querySelector('main').addEventListener('click', function (e) {
    var cardsInverted = document.querySelectorAll('.card-inverted');
    cardsInverted.forEach(function (i) {
      if (i.classList.contains('rotate360') && !e.target.classList.contains('translate-icon')) {
        var card = i.parentElement.firstElementChild;
        card.classList.remove('rotate180');
        i.classList.remove('rotate360');
      }
    });
...
function showBlockOnPlay() {
  if (localStorage.getItem('theme') === 'play') {
    var block = document.querySelector('.play-block');
...
function showTextUnderPlayBtn(showText) {
  var parent = document.querySelector('.header-main');
...
function cleanTextUnderPlayBtn() {
  var text = document.querySelector('.text-btn');
  if (text) {
    text.remove();
  }
}
...
/* harmony import */ var _clickPlayButton__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./clickPlayButton */ "./js/pages/categoryPage/clickPlayButton.js");
/* harmony import */ var _statisticsPage_createLocalStorage__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../statisticsPage/createLocalStorage */ "./js/pages/statisticsPage/createLocalStorage.js");
/* harmony import */ var _statisticsPage_trainDifficultWords__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../statisticsPage/trainDifficultWords */ "./js/pages/statisticsPage/trainDifficultWords.js");
/* harmony import */ var _showPage__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../showPage */ "./js/pages/showPage.js");
...
function finishGame() {
  (0,_clickPlayButton__WEBPACK_IMPORTED_MODULE_10__.showBlockOnPlay)();
  (0,_clickPlayButton__WEBPACK_IMPORTED_MODULE_10__.changeTextOnBtn)('PLAY');
  showResult();
}
function showResult() {
  var blockedLayer = document.querySelector('.play-block');
  ...
  if (document.querySelector('.heart-bad')) {
    ...
    (0,_clickPlayButton__WEBPACK_IMPORTED_MODULE_10__.showTextUnderPlayBtn)('You lose. Click to play again');
    new Audio('./assets/audio/loseGame.mp3').play();
  } else {
    result.setAttribute('src', './assets/icons/win.jpg');
    (0,_clickPlayButton__WEBPACK_IMPORTED_MODULE_10__.showTextUnderPlayBtn)('You won! Click to play again');
    new Audio('./assets/audio/winGame.mp3').play();
  }
  blockedLayer.prepend(result);
}
function addHeart(type) {
  var parent = document.querySelector('.hearts-container');
  if (parent) {
    ...
    _parent.classList.add('hearts-container');
    header.append(_parent);
    addHeart(type);
  }
}
function blockCardClick(blockCard) {
  document.querySelector("#".concat(blockCard)).classList.add('block-card');
}
function checkCorrectCard(e) {
  var blockCard = (0,_showPage__WEBPACK_IMPORTED_MODULE_13__.shortName)(getCurrentCard().title);
  if (e.target.getAttribute('id') === blockCard) {
    new Audio('./assets/audio/win.mp3').play();
    (0,_statisticsPage_createLocalStorage__WEBPACK_IMPORTED_MODULE_11__.editStatistics)(getCurrentCard().key, getCurrentCard().title, 'playClick');
    ...
    (0,_statisticsPage_createLocalStorage__WEBPACK_IMPORTED_MODULE_11__.editStatistics)(getCurrentCard().key, getCurrentCard().title, 'errors');
    (0,_statisticsPage_createLocalStorage__WEBPACK_IMPORTED_MODULE_11__.editStatistics)(getCurrentCard().key, getCurrentCard().title, 'playClick');
  }
}
function setNextCardAsActive() {
  var resourse = JSON.parse(localStorage.getItem('statistic'));
  var currentPage = localStorage.getItem('page');
  var cards = document.querySelectorAll('.card');
  var numOfActiveCard = getCardsOrder()[0];
  var activeCard = cards[numOfActiveCard];
  var currentCardObj;
  var arrForSearch;
  if (currentPage !== 'difficult') {
    arrForSearch = resourse[currentPage];
  } else {
    arrForSearch = (0,_statisticsPage_trainDifficultWords__WEBPACK_IMPORTED_MODULE_12__.returnAllWords)();
  }
  arrForSearch.forEach(function (i) {
...
/* harmony import */ var _showPage__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../showPage */ "./js/pages/showPage.js");
/* harmony import */ var _headerLayout__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./headerLayout */ "./js/pages/header/headerLayout.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
function createHeader() {
  (0,_headerLayout__WEBPACK_IMPORTED_MODULE_14__["default"])();
  var btnMain = document.querySelector('.main-page');
  var btnStatistic = document.querySelector('.statistic-page');
  btnMain.addEventListener('click', function () {
    (0,_showPage__WEBPACK_IMPORTED_MODULE_13__["default"])('sections');
  });
  btnStatistic.addEventListener('click', function () {
    (0,_showPage__WEBPACK_IMPORTED_MODULE_13__["default"])('statistic');
  });
  var resourse = JSON.parse(localStorage.getItem('statistic'));
  resourse.sections.forEach(function (i) {
    new liCreate(i.title).render();
  });
}
var liCreate = /*#__PURE__*/function () {
  function liCreate(title) {
    _classCallCheck(this, liCreate);
    this.title = title;
  }
  _createClass(liCreate, [{
    key: "render",
    value: function render() {
      var _this = this;
      ...
      li.innerHTML = "\n            <span class=\"change-section-header\">".concat(this.title, "</span>\n        ");
      container.append(li);
      var span = li.querySelector("span");
      span.addEventListener('click', function () {
        (0,_showPage__WEBPACK_IMPORTED_MODULE_13__["default"])(_this.title);
      });
    }
  }]);
  return liCreate;
...
function createHeaderLayout() {
  ...
  var menuBtn = header.querySelector('.toggler');
  var menu = header.querySelector('.header-cont');
...
function closeMenu() {
  var menu = document.querySelector('.header-cont');
  if (!menu.classList.contains('hide')) {
    menu.classList.add('hide');
  }
  var menuBtn = document.querySelector('.toggler');
  if (menuBtn.classList.contains('hide')) {
    menuBtn.classList.remove('hide');
  }
  var backg = document.querySelector('.background-all');
...
function mainPageLayout() {
  var parentOfMainLayout = document.createElement("div");
...
/* harmony import */ var _showPage__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../showPage */ "./js/pages/showPage.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var Card = /*#__PURE__*/function () {
  function Card(src, title) {
    var cardsNum = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      ...
      var col = document.createElement("div");
      col.classList.add("col");
      col.innerHTML = "\n            <div class=\"card\">\n                <img src=".concat(this.src, " alt=").concat(this.alt, " class=\"album-img\">\n                    <div class=\"cards-numbers\">\n                        <p class=\"card-text\">").concat(this.title, "</p>\n                        <small class=\"text-muted\">").concat(this.cardsNum, " cards</small>\n                    </div>\n                </div>\n            </div>\n        ");
      this.parent.append(col);
      var card = col.querySelector('.card');
      card.addEventListener('click', function () {
        (0,_showPage__WEBPACK_IMPORTED_MODULE_12__["default"])(_this.title);
      });
    }
  }]);
  return Card;
...
/* harmony import */ var _mainPage_sectionsCardsCreater__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./mainPage/sectionsCardsCreater */ "./js/pages/mainPage/sectionsCardsCreater.js");
/* harmony import */ var _categoryPage_categoryCardCreate__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./categoryPage/categoryCardCreate */ "./js/pages/categoryPage/categoryCardCreate.js");
/* harmony import */ var _categoryPage_clickPlayButton__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./categoryPage/clickPlayButton */ "./js/pages/categoryPage/clickPlayButton.js");
/* harmony import */ var _statisticsPage_statisticPageLayout__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./statisticsPage/statisticPageLayout */ "./js/pages/statisticsPage/statisticPageLayout.js");
/* harmony import */ var _statisticsPage_trainDifficultWords__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./statisticsPage/trainDifficultWords */ "./js/pages/statisticsPage/trainDifficultWords.js");
/* harmony import */ var _header_headerLayout__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./header/headerLayout */ "./js/pages/header/headerLayout.js");
...
function cleanPage() {
  ...
  var cardParent = album.querySelector('.row');
...
function showPage(category) {
  (0,_header_headerLayout__WEBPACK_IMPORTED_MODULE_11__.closeMenu)();
  cleanPage();
  (0,_categoryPage_clickPlayButton__WEBPACK_IMPORTED_MODULE_8__.cleanForNewGame)();
  (0,_categoryPage_clickPlayButton__WEBPACK_IMPORTED_MODULE_8__.changeTextOnBtn)('PLAY');
  category = shortName(category);
  localStorage.setItem('page', category);
  var resourse = JSON.parse(localStorage.getItem('statistic'));
  if (category === 'sections') {
    (0,_categoryPage_clickPlayButton__WEBPACK_IMPORTED_MODULE_8__.hideBlockOnPlay)();
    resourse.sections.forEach(function (_ref) {
      var src = _ref.src,
        title = _ref.title;
      var cardsNum = resourse[shortName(title)].length;
      new _mainPage_sectionsCardsCreater__WEBPACK_IMPORTED_MODULE_6__["default"](src, title, cardsNum).render();
    });
  } else if (category === 'difficult') {
    (0,_categoryPage_clickPlayButton__WEBPACK_IMPORTED_MODULE_8__.showBlockOnPlay)();
    (0,_statisticsPage_trainDifficultWords__WEBPACK_IMPORTED_MODULE_10__.difficultPageCreate)();
  } else if (category === 'statistic') {
    (0,_categoryPage_clickPlayButton__WEBPACK_IMPORTED_MODULE_8__.hideBlockOnPlay)();
    (0,_statisticsPage_statisticPageLayout__WEBPACK_IMPORTED_MODULE_9__["default"])();
    hidePlayBtn();
  } else {
    (0,_categoryPage_clickPlayButton__WEBPACK_IMPORTED_MODULE_8__.showBlockOnPlay)();
    resourse[category].forEach(function (_ref2) {
      var src = _ref2.src,
        title = _ref2.title,
        translate = _ref2.translate,
        audio = _ref2.audio,
        key = _ref2.key;
      new _categoryPage_categoryCardCreate__WEBPACK_IMPORTED_MODULE_7__.CategoryCard(src, title, translate, audio, key).render();
    });
  }
}
...
/* harmony import */ var _services_getResource__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../services/getResource */ "./js/services/getResource.js");
/* harmony import */ var _statisticPageLayout__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./statisticPageLayout */ "./js/pages/statisticsPage/statisticPageLayout.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var createLocalStorage = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0,_services_getResource__WEBPACK_IMPORTED_MODULE_22__.getResource)().then(function (data) {
  ...
  return function createLocalStorage() {
    return _ref.apply(this, arguments);
  };
}();
function editStatistics(section, title, typeOfClick) {
  var newData = JSON.parse(localStorage.getItem('statistic'));
  newData[section].forEach(function (item) {
    if (item.title === title) {
      item[typeOfClick]++;
    }
  });
...
function resetStatistic() {
  var newData = JSON.parse(localStorage.getItem('statistic'));
  var section = Object.keys(newData);
  section.forEach(function (i) {
    if (i !== 'sections') {
      newData[i].forEach(function (item) {
        item.trainClick = 0;
        item.playClick = 0;
        item.errors = 0;
      });
  ...
  (0,_statisticPageLayout__WEBPACK_IMPORTED_MODULE_23__["default"])();
}
...
/* harmony import */ var _statisticPageLayout__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./statisticPageLayout */ "./js/pages/statisticsPage/statisticPageLayout.js");
...
function returnAllWords() {
  var statistic = JSON.parse(localStorage.getItem('statistic'));
  var keys = Object.keys(statistic);
  var arr = [];
  keys.forEach(function (key) {
    if (key !== 'sections') {
      statistic[key].forEach(function (i) {
        arr.push(i);
      });
    }
  });
...
function createStatisticsBySection(keys) {
  ...
  keys.forEach(function (key) {
    if (key !== 'sections') {
      statistic[key].forEach(function (_ref) {
        var title = _ref.title,
          translate = _ref.translate,
          trainClick = _ref.trainClick,
          playClick = _ref.playClick,
          errors = _ref.errors;
        (0,_statisticPageLayout__WEBPACK_IMPORTED_MODULE_8__.createStatistics)(num, key, title, translate, trainClick, playClick, errors);
        num++;
      });
    }
  });
...
function createStatisticsByWord(arr) {
  ...
  arr.forEach(function (_ref2) {
    var title = _ref2.title,
      translate = _ref2.translate,
      trainClick = _ref2.trainClick,
      playClick = _ref2.playClick,
      errors = _ref2.errors,
      key = _ref2.key;
    (0,_statisticPageLayout__WEBPACK_IMPORTED_MODULE_8__.createStatistics)(num, key, title, translate, trainClick, playClick, errors);
    num++;
...
function statisticFilter(filter, reverse) {
  ...
  switch (filter) {
    ...
    case "Sr. No.":
      ...
      break;
    case "Word":
      var newArr = reverse ? tableSort(returnAllWords(), 'title') : tableSort(returnAllWords(), 'title').reverse();
      createStatisticsByWord(newArr);
      break;
    case "Translation":
      var arr = reverse ? tableSort(returnAllWords(), 'translate') : tableSort(returnAllWords(), 'translate').reverse();
      createStatisticsByWord(arr);
      break;
    case "trainClick":
      var clickArr = reverse ? tableSort(returnAllWords(), 'trainClick') : tableSort(returnAllWords(), 'trainClick').reverse();
      createStatisticsByWord(clickArr);
      break;
    case "playClick":
      var clickArrPlay = reverse ? tableSort(returnAllWords(), 'playClick') : tableSort(returnAllWords(), 'playClick').reverse();
      createStatisticsByWord(clickArrPlay);
      break;
    case "errors":
      var errorClick = reverse ? tableSort(returnAllWords(), 'errors') : tableSort(returnAllWords(), 'errors').reverse();
      createStatisticsByWord(errorClick);
      break;
    case "percent":
      var perClick = reverse ? tableSort(returnAllWords(), "percent") : tableSort(returnAllWords(), "percent").reverse();
      createStatisticsByWord(perClick);
      break;
  }
}
function returnEightErrorsOrLess() {
  var errorClick = tableSort(returnAllWords(), 'errors');
  errorClick = errorClick.filter(function (i) {
    return i.errors !== 0;
  }).reverse();
...
/* harmony import */ var _createLocalStorage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./createLocalStorage */ "./js/pages/statisticsPage/createLocalStorage.js");
/* harmony import */ var _statisticFilter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./statisticFilter */ "./js/pages/statisticsPage/statisticFilter.js");
/* harmony import */ var _showPage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../showPage */ "./js/pages/showPage.js");
...
function createTh(parent, inner) {
  ...
  heading.innerHTML = "<button class=\"dropbtn\">".concat(inner, "<i class=\"fa fa-caret-down\"></i></button><div class=\"dropdown-content hide\"><div class=\"ascending\">In ascending order</div><div class=\"descending\">In descending order</div></div>");
  var ascending = heading.querySelector('.ascending');
  var descending = heading.querySelector('.descending');
  ascending.addEventListener('click', function () {
    (0,_statisticFilter__WEBPACK_IMPORTED_MODULE_6__["default"])(inner, true);
  });
  descending.addEventListener('click', function () {
    (0,_statisticFilter__WEBPACK_IMPORTED_MODULE_6__["default"])(inner, false);
  });
...
function createLegend(container) {
  ...
  var containerLegend = document.createElement('div');
...
function createStatisticBtn() {
  var container = document.querySelector('.statistic-group');
  ...
  resetBtn.addEventListener('click', function () {
    (0,_createLocalStorage__WEBPACK_IMPORTED_MODULE_5__.resetStatistic)();
  });
  diffBtn.addEventListener('click', function () {
    (0,_showPage__WEBPACK_IMPORTED_MODULE_7__["default"])('Difficult');
  });
}
...
function createRow(parent, inner) {
  var addClass = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
...
function createStatistics(num, category, word, translation, trainClick, playClick, errors) {
  var tbody = document.querySelector('tbody');
  var percent = Math.floor(errors / playClick * 100) | 0;
...
function createStatisticsPageLayout() {
  var container = document.querySelector('.album').querySelector('.container');
  ...
  if (!document.querySelector('table')) {
    ...
    (0,_statisticFilter__WEBPACK_IMPORTED_MODULE_6__["default"])('Sr. No.', true);
...
function closeDropdownContent(e) {
  if (!e.target.classList.contains('dropbtn')) {
    var myDropdowns = document.querySelectorAll(".dropdown-content");
    myDropdowns.forEach(function (i) {
  ...
  if (e.target.classList.contains('dropbtn')) {
    ...
    var content = e.target.parentElement.querySelector('.dropdown-content');
    allContents.forEach(function (i) {
...
/* harmony export */   "returnAllWords": () => (/* reexport safe */ _statisticFilter__WEBPACK_IMPORTED_MODULE_4__.returnAllWords)
/* harmony export */ });
/* harmony import */ var core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.for-each.js */ "./node_modules/core-js/modules/es.array.for-each.js");
/* harmony import */ var core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.object.to-string.js */ "./node_modules/core-js/modules/es.object.to-string.js");
...
/* harmony import */ var _statisticFilter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./statisticFilter */ "./js/pages/statisticsPage/statisticFilter.js");
/* harmony import */ var _categoryPage_categoryCardCreate__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../categoryPage/categoryCardCreate */ "./js/pages/categoryPage/categoryCardCreate.js");
...
function zeroErrorsPage() {
  (0,_showPage__WEBPACK_IMPORTED_MODULE_3__.hidePlayBtn)();
...
function difficultPageCreate() {
  var errors = (0,_statisticFilter__WEBPACK_IMPORTED_MODULE_4__.returnEightErrorsOrLess)();
  if (errors.length !== 0) {
    errors.forEach(function (error) {
      new _categoryPage_categoryCardCreate__WEBPACK_IMPORTED_MODULE_5__.CategoryCard(error.src, error.title, error.translate, error.audio, error.key).render();
    });
  } else {
    zeroErrorsPage();
  }
...
function applyTheme(themeName) {
  var themeUrl = "css/".concat(themeName, "-theme.css");
...
var url = 'https://irmakdak.github.io/English-for-kids/cards.json';
function getUrl() {
  return url;
}
...
document.addEventListener("DOMContentLoaded", function () {
  if (!localStorage.getItem('statistic')) {
    (0,_pages_statisticsPage_createLocalStorage__WEBPACK_IMPORTED_MODULE_6__["default"])().then(function () {
      start();
    });
  } else {
    start();
...
/* harmony import */ var core_js_modules_es_array_slice_js__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! core-js/modules/es.array.slice.js */ "./node_modules/core-js/modules/es.array.slice.js");
/* harmony import */ var core_js_modules_es_array_slice_js__WEBPACK_IMPORTED_MODULE_21___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_slice_js__WEBPACK_IMPORTED_MODULE_21__);
/* harmony import */ var _script__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../script */ "./js/script.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return exports; }; var exports = {}, Op = Object.prototype, hasOwn = Op.hasOwnProperty, defineProperty = Object.defineProperty || function (obj, key, desc) { obj[key] = desc.value; }, $Symbol = "function" == typeof Symbol ? Symbol : {}, iteratorSymbol = $Symbol.iterator || "@@iterator", asyncIteratorSymbol = $Symbol.asyncIterator || "@@asyncIterator", toStringTagSymbol = $Symbol.toStringTag || "@@toStringTag"; function define(obj, key, value) { return Object.defineProperty(obj, key, { value: value, enumerable: !0, configurable: !0, writable: !0 }), obj[key]; } try { define({}, ""); } catch (err) { define = function define(obj, key, value) { return obj[key] = value; }; } function wrap(innerFn, outerFn, self, tryLocsList) { var protoGenerator = outerFn && outerFn.prototype instanceof Generator ? outerFn : Generator, generator = Object.create(protoGenerator.prototype), context = new Context(tryLocsList || []); return defineProperty(generator, "_invoke", { value: makeInvokeMethod(innerFn, self, context) }), generator; } function tryCatch(fn, obj, arg) { try { return { type: "normal", arg: fn.call(obj, arg) }; } catch (err) { return { type: "throw", arg: err }; } } exports.wrap = wrap; var ContinueSentinel = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var IteratorPrototype = {}; define(IteratorPrototype, iteratorSymbol, function () { return this; }); var getProto = Object.getPrototypeOf, NativeIteratorPrototype = getProto && getProto(getProto(values([]))); NativeIteratorPrototype && NativeIteratorPrototype !== Op && hasOwn.call(NativeIteratorPrototype, iteratorSymbol) && (IteratorPrototype = NativeIteratorPrototype); var Gp = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(IteratorPrototype); function defineIteratorMethods(prototype) { ["next", "throw", "return"].forEach(function (method) { define(prototype, method, function (arg) { return this._invoke(method, arg); }); }); } function AsyncIterator(generator, PromiseImpl) { function invoke(method, arg, resolve, reject) { var record = tryCatch(generator[method], generator, arg); if ("throw" !== record.type) { var result = record.arg, value = result.value; return value && "object" == _typeof(value) && hasOwn.call(value, "__await") ? PromiseImpl.resolve(value.__await).then(function (value) { invoke("next", value, resolve, reject); }, function (err) { invoke("throw", err, resolve, reject); }) : PromiseImpl.resolve(value).then(function (unwrapped) { result.value = unwrapped, resolve(result); }, function (error) { return invoke("throw", error, resolve, reject); }); } reject(record.arg); } var previousPromise; defineProperty(this, "_invoke", { value: function value(method, arg) { function callInvokeWithMethodAndArg() { return new PromiseImpl(function (resolve, reject) { invoke(method, arg, resolve, reject); }); } return previousPromise = previousPromise ? previousPromise.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(innerFn, self, context) { var state = "suspendedStart"; return function (method, arg) { if ("executing" === state) throw new Error("Generator is already running"); if ("completed" === state) { if ("throw" === method) throw arg; return doneResult(); } for (context.method = method, context.arg = arg;;) { var delegate = context.delegate; if (delegate) { var delegateResult = maybeInvokeDelegate(delegate, context); if (delegateResult) { if (delegateResult === ContinueSentinel) continue; return delegateResult; } } if ("next" === context.method) context.sent = context._sent = context.arg;else if ("throw" === context.method) { if ("suspendedStart" === state) throw state = "completed", context.arg; context.dispatchException(context.arg); } else "return" === context.method && context.abrupt("return", context.arg); state = "executing"; var record = tryCatch(innerFn, self, context); if ("normal" === record.type) { if (state = context.done ? "completed" : "suspendedYield", record.arg === ContinueSentinel) continue; return { value: record.arg, done: context.done }; } "throw" === record.type && (state = "completed", context.method = "throw", context.arg = record.arg); } }; } function maybeInvokeDelegate(delegate, context) { var methodName = context.method, method = delegate.iterator[methodName]; if (undefined === method) return context.delegate = null, "throw" === methodName && delegate.iterator["return"] && (context.method = "return", context.arg = undefined, maybeInvokeDelegate(delegate, context), "throw" === context.method) || "return" !== methodName && (context.method = "throw", context.arg = new TypeError("The iterator does not provide a '" + methodName + "' method")), ContinueSentinel; var record = tryCatch(method, delegate.iterator, context.arg); if ("throw" === record.type) return context.method = "throw", context.arg = record.arg, context.delegate = null, ContinueSentinel; var info = record.arg; return info ? info.done ? (context[delegate.resultName] = info.value, context.next = delegate.nextLoc, "return" !== context.method && (context.method = "next", context.arg = undefined), context.delegate = null, ContinueSentinel) : info : (context.method = "throw", context.arg = new TypeError("iterator result is not an object"), context.delegate = null, ContinueSentinel); } function pushTryEntry(locs) { var entry = { tryLoc: locs[0] }; 1 in locs && (entry.catchLoc = locs[1]), 2 in locs && (entry.finallyLoc = locs[2], entry.afterLoc = locs[3]), this.tryEntries.push(entry); } function resetTryEntry(entry) { var record = entry.completion || {}; record.type = "normal", delete record.arg, entry.completion = record; } function Context(tryLocsList) { this.tryEntries = [{ tryLoc: "root" }], tryLocsList.forEach(pushTryEntry, this), this.reset(!0); } function values(iterable) { if (iterable) { var iteratorMethod = iterable[iteratorSymbol]; if (iteratorMethod) return iteratorMethod.call(iterable); if ("function" == typeof iterable.next) return iterable; if (!isNaN(iterable.length)) { var i = -1, next = function next() { for (; ++i < iterable.length;) if (hasOwn.call(iterable, i)) return next.value = iterable[i], next.done = !1, next; return next.value = undefined, next.done = !0, next; }; return next.next = next; } } return { next: doneResult }; } function doneResult() { return { value: undefined, done: !0 }; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, defineProperty(Gp, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), defineProperty(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, toStringTagSymbol, "GeneratorFunction"), exports.isGeneratorFunction = function (genFun) { var ctor = "function" == typeof genFun && genFun.constructor; return !!ctor && (ctor === GeneratorFunction || "GeneratorFunction" === (ctor.displayName || ctor.name)); }, exports.mark = function (genFun) { return Object.setPrototypeOf ? Object.setPrototypeOf(genFun, GeneratorFunctionPrototype) : (genFun.__proto__ = GeneratorFunctionPrototype, define(genFun, toStringTagSymbol, "GeneratorFunction")), genFun.prototype = Object.create(Gp), genFun; }, exports.awrap = function (arg) { return { __await: arg }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, asyncIteratorSymbol, function () { return this; }), exports.AsyncIterator = AsyncIterator, exports.async = function (innerFn, outerFn, self, tryLocsList, PromiseImpl) { void 0 === PromiseImpl && (PromiseImpl = Promise); var iter = new AsyncIterator(wrap(innerFn, outerFn, self, tryLocsList), PromiseImpl); return exports.isGeneratorFunction(outerFn) ? iter : iter.next().then(function (result) { return result.done ? result.value : iter.next(); }); }, defineIteratorMethods(Gp), define(Gp, toStringTagSymbol, "Generator"), define(Gp, iteratorSymbol, function () { return this; }), define(Gp, "toString", function () { return "[object Generator]"; }), exports.keys = function (val) { var object = Object(val), keys = []; for (var key in object) keys.push(key); return keys.reverse(), function next() { for (; keys.length;) { var key = keys.pop(); if (key in object) return next.value = key, next.done = !1, next; } return next.done = !0, next; }; }, exports.values = values, Context.prototype = { constructor: Context, reset: function reset(skipTempReset) { if (this.prev = 0, this.next = 0, this.sent = this._sent = undefined, this.done = !1, this.delegate = null, this.method = "next", this.arg = undefined, this.tryEntries.forEach(resetTryEntry), !skipTempReset) for (var name in this) "t" === name.charAt(0) && hasOwn.call(this, name) && !isNaN(+name.slice(1)) && (this[name] = undefined); }, stop: function stop() { this.done = !0; var rootRecord = this.tryEntries[0].completion; if ("throw" === rootRecord.type) throw rootRecord.arg; return this.rval; }, dispatchException: function dispatchException(exception) { if (this.done) throw exception; var context = this; function handle(loc, caught) { return record.type = "throw", record.arg = exception, context.next = loc, caught && (context.method = "next", context.arg = undefined), !!caught; } for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i], record = entry.completion; if ("root" === entry.tryLoc) return handle("end"); if (entry.tryLoc <= this.prev) { var hasCatch = hasOwn.call(entry, "catchLoc"), hasFinally = hasOwn.call(entry, "finallyLoc"); if (hasCatch && hasFinally) { if (this.prev < entry.catchLoc) return handle(entry.catchLoc, !0); if (this.prev < entry.finallyLoc) return handle(entry.finallyLoc); } else if (hasCatch) { if (this.prev < entry.catchLoc) return handle(entry.catchLoc, !0); } else { if (!hasFinally) throw new Error("try statement without catch or finally"); if (this.prev < entry.finallyLoc) return handle(entry.finallyLoc); } } } }, abrupt: function abrupt(type, arg) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.tryLoc <= this.prev && hasOwn.call(entry, "finallyLoc") && this.prev < entry.finallyLoc) { var finallyEntry = entry; break; } } finallyEntry && ("break" === type || "continue" === type) && finallyEntry.tryLoc <= arg && arg <= finallyEntry.finallyLoc && (finallyEntry = null); var record = finallyEntry ? finallyEntry.completion : {}; return record.type = type, record.arg = arg, finallyEntry ? (this.method = "next", this.next = finallyEntry.finallyLoc, ContinueSentinel) : this.complete(record); }, complete: function complete(record, afterLoc) { if ("throw" === record.type) throw record.arg; return "break" === record.type || "continue" === record.type ? this.next = record.arg : "return" === record.type ? (this.rval = this.arg = record.arg, this.method = "return", this.next = "end") : "normal" === record.type && afterLoc && (this.next = afterLoc), ContinueSentinel; }, finish: function finish(finallyLoc) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.finallyLoc === finallyLoc) return this.complete(entry.completion, entry.afterLoc), resetTryEntry(entry), ContinueSentinel; } }, "catch": function _catch(tryLoc) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.tryLoc === tryLoc) { var record = entry.completion; if ("throw" === record.type) { var thrown = record.arg; resetTryEntry(entry); } return thrown; } } throw new Error("illegal catch attempt"); }, delegateYield: function delegateYield(iterable, resultName, nextLoc) { return this.delegate = { iterator: values(iterable), resultName: resultName, nextLoc: nextLoc }, "next" === this.method && (this.arg = undefined), ContinueSentinel; } }, exports; }
...
var getResource = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = (0,_script__WEBPACK_IMPORTED_MODULE_22__["default"])();
          _context.next = 3;
          return fetch(url, {
            method: "GET"
          });
